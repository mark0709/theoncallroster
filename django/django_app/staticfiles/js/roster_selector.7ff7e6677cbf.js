    ...
    */
    ...
    function callback(response)
    {
      ...
      $.each(JSON.parse(response), function(key,value)
      {
        ...
        //console.log("Current Oncall - oss_person_id: " + value[0], "nw_person_id: " + value[1]);
      })
    }
    ...
    $.ajax({ url: '/ajax_return_oncall/',
      ...
      function callback2(data)
      {
        ...
        $.each(JSON.parse(data), function(key,value)
        {
          ...
          console.log(d, "oss_person_id " + value[1], "nw_person_id: " + value[2])
          $('#changelog').find('tbody:last').after('<tr><td>' + d + '</td><td>' + value[1] + '</td><td>' + value[2] + '</td></tr>');
        });
      }
  }).trigger('change');
});
